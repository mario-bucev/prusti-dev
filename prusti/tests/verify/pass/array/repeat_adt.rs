...
// Carbon cannot verify the postcondition unfortunately, albeit seemingly having all definitions in scope
// #[ensures="forall i: usize :: (0 <= i && i < LEN) ==> (result[i].value == 42 && result[i].bar.value == 1234)"]
...
// See 'repeat_adt' for more details
